 ...
 *
 * https://github.com/divyanshshekhar/springboot-embedded-mongo-replset-demo/blob/main/src/test/java/com/dsgaur/spring/embedded/demo/tests/config/EmbeddedMongoConfigOverride.java
 *
...
public class EmbeddedMongoConfigOverride {
    ...
    private IFeatureAwareVersion determineVersion(EmbeddedMongoProperties embeddedProperties) {
        ...
        for(int var4 = 0; var4 < var3; ++var4) {
            Version version = var2[var4];
            if (version.asInDownloadPath().equals(embeddedProperties.getVersion())) {
                return version;
            }
        }

        return Versions.withFeatures(this.createEmbeddedMongoVersion(embeddedProperties));
    }
